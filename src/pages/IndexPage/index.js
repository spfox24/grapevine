    ...
    return (
        <div className="Page">
            ...
            <div className="b-index">
                ...
                <p className="text-content"><strong>Grapevine Social&copy;</strong> was designed to be a community driven application with what content is trending now. Many times we get recommendations from friends or family for what content to stream, listen to, or read. <strong>Grapevine Social&copy;</strong> brings your community together all in one place. <br/>
